...
module.exports = /** @type {const} */ ({
  ...
  rules: {
    ...
    'no-proto': 2,
    // enum は使わない
    'no-restricted-syntax': [2, { selector: 'TSEnumDeclaration', message: "Don't declare enums" }],
    ...
    // import/export 文の並びは eslint-plugin-simple-import-sort に委譲する
    'import/order': 0,
    // package.json への追加忘れを防止
    'import/no-extraneous-dependencies': 2,

    // ***** eslint-plugin-simple-import-sort *****
    // import/export 文の並びについて思考するのに時間を費やすのは勿体ないので、一律でソートしてしまう
    'simple-import-sort/imports': 2,
    'simple-import-sort/exports': 2,

    // ***** eslint-plugin-sort-destructure-keys *****
    // オブジェクトの destructure ではキーをソートする
